# %% [markdown]
# fNIRS Training Notebook Launcher
#
...
DATA_DIR = (
    Path("/content/drive/MyDrive/ROBIO2025_data/PPfNIRS").expanduser()
    if PROJECT_ROOT.as_posix().startswith("/content/")
    else PROJECT_ROOT / "PPfNIRS"
)
